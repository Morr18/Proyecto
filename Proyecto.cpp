...
int main(){
    ...
    while(opc!=8){
        ...
        if (opc==4){
            ...
            for (int a=0; a<cantidadVuelos; a++){
                if (aerolineaAnt[a] != datosVuelosT[cantidadVuelos].getAerolinea()){
                    aerolineaAnt[a]=datosVuelosT[cantidadVuelos].getAerolinea();
                    aero++;
                }
            }
            cout << aero << endl;
